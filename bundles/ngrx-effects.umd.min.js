...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var l=function(e,t){return(l=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(e,t)};function d(e,t){function r(){this.constructor=e}l(e,t),e.prototype=null===t?Object.create(t):(r.prototype=t.prototype,new r)}Object.create;function y(e){var t="function"==typeof Symbol&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&"number"==typeof e.length)return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")}function g(e,t){var r="function"==typeof Symbol&&e[Symbol.iterator];if(!r)return e;var n,o,c=r.call(e),f=[];try{for(;(void 0===t||t-- >0)&&!(n=c.next()).done;)f.push(n.value)}catch(e){o={error:e}}finally{try{n&&!n.done&&(r=c.return)&&r.call(c)}finally{if(o)throw o.error}}return f}function v(){for(var e=[],t=0;t<arguments.length;t++)e=e.concat(g(arguments[t]));return e}Object.create;function E(e,t,o){var c=i(e).constructor.name,f=p(e).map((function(r){var f=r.propertyName,i=r.dispatch,u=r.useEffectsErrorHandler,a="function"==typeof e[f]?e[f]():e[f],s=u?o(a,t):a;return!1===i?s.pipe(n.ignoreElements()):s.pipe(n.materialize()).pipe(n.map((function(t){return{effect:e[f],notification:t,propertyName:f,sourceName:c,sourceInstance:e}})))}));return r.merge.apply(void 0,v(f))}function h(e,t,r){return void 0===r&&(r=10),e.pipe(n.catchError((function(n){return t&&t.handleError(n),r<=1?e:h(e,t,r-1)})))}var b=function(e){function t(t){var r=e.call(this)||this;return t&&(r.source=t),r}return d(t,e),t.prototype.lift=function(e){var r=new t;return r.source=this,r.operator=e,r},t}(r.Observable);function m(e,t){if("N"===e.notification.kind){var r=e.notification.value;!function(e){return"function"!=typeof e&&e&&e.type&&"string"==typeof e.type}(r)&&t.handleError(new Error("Effect "+(o=(n=e).propertyName,c=n.sourceInstance,f=n.sourceName,i="function"==typeof c[o],'"'+f+"."+String(o)+(i?"()":"")+'"')+" dispatched an invalid action: "+function(e){try{return JSON.stringify(e)}catch(t){return e}}(r)))}var n,o,c,f,i}b.decorators=[{type:o.Injectable}],b.ctorParameters=function(){return[{type:r.Observable,decorators:[{type:o.Inject,args:[t.ScannedActionsSubject]}]}]};function j(e){return x(e,"ngrxOnInitEffects")}function x(e,t){return e&&t in e&&"function"==typeof e[t]}var _=new o.InjectionToken("@ngrx/effects Internal Root Guard"),O=new o.InjectionToken("@ngrx/effects User Provided Effects"),S=new o.InjectionToken("@ngrx/effects Internal Root Effects"),I=new o.InjectionToken("@ngrx/effects Root Effects"),w=new o.InjectionToken("@ngrx/effects Internal Feature Effects"),M=new o.InjectionToken("@ngrx/effects Feature Effects"),N=new o.InjectionToken("@ngrx/effects Effects Error Handler"),R=function(e){function t(t,r){var n=e.call(this)||this;return n.errorHandler=t,n.effectsErrorHandler=r,n}return d(t,e),t.prototype.addEffects=function(e){this.next(e)},t.prototype.toActions=function(){var e=this;return this.pipe(n.groupBy(i),n.mergeMap((function(e){return e.pipe(n.groupBy(F))})),n.mergeMap((function(t){var o=t.pipe(n.exhaustMap((function(t){return(r=e.errorHandler,n=e.effectsErrorHandler,function(e){var t=E(e,r,n);return x(e,"ngrxOnRunEffects")?e.ngrxOnRunEffects(t):t})(t);var r,n})),n.map((function(t){return m(t,e.errorHandler),t.notification})),n.filter((function(e){return"N"===e.kind})),n.dematerialize()),c=t.pipe(n.take(1),n.filter(j),n.map((function(e){return e.ngrxOnInitEffects()})));return r.merge(o,c)})))},t}(r.Subject);function F(e){return x(e,"ngrxOnIdentifyEffects")?e.ngrxOnIdentifyEffects():""}R.decorators=[{type:o.Injectable}],R.ctorParameters=function(){return[{type:o.ErrorHandler},{type:void 0,decorators:[{type:o.Inject,args:[N]}]}]};var P=function(){function e(e,t){this.effectSources=e,this.store=t,this.effectsSubscription=null}return e.prototype.start=function(){this.effectsSubscription||(this.effectsSubscription=this.effectSources.toActions().subscribe(this.store))},e.prototype.ngOnDestroy=function(){this.effectsSubscription&&(this.effectsSubscription.unsubscribe(),this.effectsSubscription=null)},e}();P.decorators=[{type:o.Injectable}],P.ctorParameters=function(){return[{type:R},{type:t.Store}]};var T=t.createAction("@ngrx/effects/init"),H=function(){function e(e,t,r,n,o,c,f){this.sources=e,t.start(),n.forEach((function(t){return e.addEffects(t)})),r.dispatch({type:"@ngrx/effects/init"})}return e.prototype.addEffects=function(e){this.sources.addEffects(e)},e}();H.decorators=[{type:o.NgModule,args:[{}]}],H.ctorParameters=function(){return[{type:R},{type:P},{type:t.Store},{type:Array,decorators:[{type:o.Inject,args:[I]}]},{type:t.StoreRootModule,decorators:[{type:o.Optional}]},{type:t.StoreFeatureModule,decorators:[{type:o.Optional}]},{type:void 0,decorators:[{type:o.Optional},{type:o.Inject,args:[_]}]}]};var k=function(e,t,r,n){t.forEach((function(t){return t.forEach((function(t){return e.addEffects(t)}))}))};k.decorators=[{type:o.NgModule,args:[{}]}],k.ctorParameters=function(){return[{type:H},{type:Array,decorators:[{type:o.Inject,args:[M]}]},{type:t.StoreRootModule,decorators:[{type:o.Optional}]},{type:t.StoreFeatureModule,decorators:[{type:o.Optional}]}]};var A=function(){function e(){}return e.forFeature=function(e){return void 0===e&&(e=[]),{ngModule:k,providers:[e,{provide:w,multi:!0,useValue:e},{provide:O,multi:!0,useValue:[]},{provide:M,multi:!0,useFactory:V,deps:[o.Injector,w,O]}]}},e.forRoot=function(e){return void 0===e&&(e=[]),{ngModule:H,providers:[{provide:_,useFactory:z,deps:[[P,new o.Optional,new o.SkipSelf]]},{provide:N,useValue:h},P,R,b,e,{provide:S,useValue:[e]},{provide:O,multi:!0,useValue:[]},{provide:I,useFactory:V,deps:[o.Injector,S,O]}]}},e}();function V(e,t,r){var n,o,c,f,i=[];try{for(var u=y(t),a=u.next();!a.done;a=u.next()){var s=a.value;i.push.apply(i,v(s))}}catch(e){n={error:e}}finally{try{a&&!a.done&&(o=u.return)&&o.call(u)}finally{if(n)throw n.error}}try{for(var p=y(r),l=p.next();!l.done;l=p.next()){var d=l.value;i.push.apply(i,v(d))}}catch(e){c={error:e}}finally{try{l&&!l.done&&(f=p.return)&&f.call(p)}finally{if(c)throw c.error}}return function(e,t){return t.map((function(t){return e.get(t)}))}(e,i)}function z(e){if(e)throw new TypeError("EffectsModule.forRoot() called twice. Feature modules should use EffectsModule.forFeature() instead.");return"guarded"}A.decorators=[{type:o.NgModule,args:[{}]}],e.Actions=b,e.EFFECTS_ERROR_HANDLER=N,e.Effect=function(e){return void 0===e&&(e={}),function(t,r){!function(e,t){a(e)?e.constructor["__@ngrx/effects__"].push(t):Object.defineProperty(e.constructor,"__@ngrx/effects__",{value:[t]})}(t,Object.assign(Object.assign(Object.assign({},c),e),{propertyName:r}))}},e.EffectSources=R,e.EffectsFeatureModule=k,e.EffectsModule=A,e.EffectsRootModule=H,e.EffectsRunner=P,e.ROOT_EFFECTS_INIT="@ngrx/effects/init",e.USER_PROVIDED_EFFECTS=O,e.act=function(e,t){var o="function"==typeof e?{project:e,error:t,operator:n.concatMap,complete:void 0,unsubscribe:void 0}:Object.assign(Object.assign({},e),{operator:e.operator||n.concatMap}),c=o.project,f=o.error,i=o.complete,u=o.operator,a=o.unsubscribe;return(function(e){return r.defer((function(){var t=new r.Subject;return r.merge(e.pipe(u((function(e,o){return r.defer((function(){var u=!1,s=!1,p=0;return c(e,o).pipe(n.materialize(),n.map((function(t){switch(t.kind){case"E":return s=!0,new r.Notification("N",f(t.error,e));case"C":return u=!0,i?new r.Notification("N",i(p,e)):void 0;default:return++p,t}})),n.filter((function(e){return null!=e})),n.dematerialize(),n.finalize((function(){u||s||!a||t.next(a(p,e))})))}))}))),t)}))})},e.createEffect=function(e,t){var r=e(),n=Object.assign(Object.assign({},c),t);return Object.defineProperty(r,"__@ngrx/effects_create__",{value:n}),r},e.defaultEffectsErrorHandler=h,e.getEffectsMetadata=function(e){return p(e).reduce((function(e,t){var r=t.propertyName,n=t.dispatch,o=t.useEffectsErrorHandler;return e[r]={dispatch:n,useEffectsErrorHandler:o},e}),{})},e.mergeEffects=E,e.ofType=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];return n.filter((function(t){return e.some((function(e){return"string"==typeof e?e===t.type:e.type===t.type}))}))},e.rootEffectsInit=T,e.ɵa=p,e.ɵb=V,e.ɵc=z,e.ɵd=_,e.ɵe=S,e.ɵf=I,e.ɵg=w,e.ɵh=M,Object.defineProperty(e,"__esModule",{value:!0})}));
