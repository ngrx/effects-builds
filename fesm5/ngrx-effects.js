...
configOrProject, errorFn) {
    var _a = typeof configOrProject === 'function'
        ...
        : __assign$2(__assign$2({}, configOrProject), { operator: configOrProject.operator || concatMap }), project = _a.project, error = _a.error, complete = _a.complete, operator = _a.operator, unsubscribe = _a.unsubscribe;
    return (/**
     * @param {?} source
     * @return {?}
     */
